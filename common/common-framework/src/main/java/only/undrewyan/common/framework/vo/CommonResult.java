package only.undrewyan.common.framework.vo;

import com.alibaba.fastjson.annotation.JSONField;
import only.undrewyan.common.framework.exception.GlobalException;
import only.undrewyan.common.framework.exception.ServiceException;
import only.undrewyan.common.framework.exception.enums.GlobalErrorCodeConstants;
...
public final class CommonResult<T> implements Serializable {
    ...
    public static <T> CommonResult<T> success2(T data) {
        CommonResult<T> result = new CommonResult<>();
        result.code = GlobalErrorCodeConstants.UNAUTHORIZED.getCode();
        result.data = data;
        result.message = "";
        return result;
    }
